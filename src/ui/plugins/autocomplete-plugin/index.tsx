...
import { useToolbarState } from "@/model/providers/ToolbarContext";
...
export function AutocompletePlugin() {
  ...
  useEffect(() => {
    ...
    function updateAsyncSuggestion(refSearchPromise: SearchPromise,
      ...
      editor.update(() => {
        ...
        const node = $createAutocompleteNode(formatSuggestionText(newSuggestion),
          uuid)
    ...
    return mergeRegister(
      editor.registerNodeTransform(AutocompleteNode,
