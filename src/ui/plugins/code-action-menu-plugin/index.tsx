...
import { canBePrettier, PrettierButton } from "./components/prettier-button";
...
function getMouseInfo(event: MouseEvent): {
  ...
  if (isHTMLElement(target)) {
    const codeDOMNode = target.closest<HTMLElement>("code.edt-text-editor-theme__code");
    const isOutside = !(
      codeDOMNode ||
...
export function CodeActionMenuPlugin({
  ...
  return scopedPortal(<CodeActionMenuContainer anchorElem={anchorElem} />, anchorElem);
}
