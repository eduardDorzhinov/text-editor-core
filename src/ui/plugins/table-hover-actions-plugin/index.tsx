...
import { useDebounce } from "../code-action-menu-plugin/utils";
    ...
    (event: MouseEvent) => {
      ...
      editor.getEditorState().read(() => {
        ...
        if ($isTableCellNode(maybeTableCell)) {
          ...
          tableDOMElement = getTableElement(table,
      ...
      if (tableDOMElement) {
        ...
        if (
          parentElement &&
          parentElement.classList.contains("edt-text-editor-theme__tableScrollableWrapper")
        ) {
          tableHasScroll =
...
export default function TableHoverActionsPlugin({
  ...
  return isEditable ?
    scopedPortal(<TableHoverActionsContainer anchorElem={anchorElem} />, anchorElem) :
    null;
}
