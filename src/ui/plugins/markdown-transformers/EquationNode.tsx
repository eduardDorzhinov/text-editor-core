...
export class EquationNode extends DecoratorNode<JSX.Element> {
  ...
  static clone(node: EquationNode): EquationNode {
    return new EquationNode(
      node.__equation, node.__inline, node.__key,
    );
  }

  constructor(
    equation: string, inline?: boolean, key?: NodeKey,
  ) {
    super(key);
  ...
  static importJSON(serializedNode: SerializedEquationNode): EquationNode {
    return $createEquationNode(serializedNode.equation,
      serializedNode.inline).updateFromJSON(serializedNode);
  }
  ...
  createDOM(_config: EditorConfig): HTMLElement {
    const element = document.createElement(this.__inline ?
      "span" :
      "div");
